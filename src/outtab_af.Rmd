...
deathhfhosp <- survmy2(
  ...
  impdata2 = imp_af,
  matchdata = matchp_af, 
  crossoverdata = matchpcross_deathhosphf %>% filter(shf_sos_com_af == "Yes")
)
...
death <- survmy2(
  ...
  impdata2 = imp_af,
  matchdata = matchp_af,
  crossoverdata = matchpcross_death %>% filter(shf_sos_com_af == "Yes")
)
...
hfhosp <- survmy2(
  ...
  impdata2 = imp_af,
  matchdata = matchp_af,
  crossoverdata = matchpcross_hosphf %>% filter(shf_sos_com_af == "Yes")
)
...
deathhfhosp <- survmy2(
  ...
  crossoverdata = matchpcross_deathhosphf %>% filter(shf_sos_com_af == "No")
)
...
death <- survmy2(
  ...
  impdata2 = imp_noaf,
  matchdata = matchp_noaf,
  crossoverdata = matchpcross_death %>% filter(shf_sos_com_af == "No")
)
...
hfhosp <- survmy2(
  ...
  impdata2 = imp_noaf,
  matchdata = matchp_noaf,
  crossoverdata = matchpcross_hosphf %>% filter(shf_sos_com_af == "No")
)
