...
```{r outtabsubdeathhfhosp2, cache=cacheon, dependson="outtabsubplot", fig.cap="Subgroups First HF hospitalization/death", fig.width=5, fig.height=10}
...
```{r outtabsubdeath2, cache=cacheon, dependson="outtabsubplot", fig.cap="Subgroups Death", fig.width=5, fig.height=10}
...
```{r outtabsubhfhosp2, cache=cacheon, dependson="outtabsubplot", fig.cap="Subgroups First HF hospitalization", fig.width=5, fig.height=10}
